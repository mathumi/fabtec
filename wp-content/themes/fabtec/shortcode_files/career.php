...
function current_openings($atts) {
    ...
    if ($current_openings) {
        ...
        <p class="text"><span class="place">'.$place.'</span><span class="date">May, 2017</span></p><div>'.$content.'</div><a class="apply_job" href="mailto:info@fabtec.com?subject=Applying for '.$title.' &body=Hi">Apply for this Job</a></div>';	                    
        }
    	$html.= '</div>';        
    }
    return $html;
